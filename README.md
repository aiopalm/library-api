...
RESTful API для управления библиотекой с JWT аутентификацией
...
- Моя ошибка - хотел бы разделить бизнес логику и БД операции, вынеся операции в отдельные модули
- Добавить автотесты в workflows
